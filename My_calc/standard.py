...
class Ui_standard(object):
    def setupUi(self, standard):
        ...
        self.model.setGeometry(QtCore.QRect(150, 10, 111, 31))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, standard):
        ...
        self.selectwindow.setItemText(0, _translate("standard", "Обычный"))
        self.selectwindow.setItemText(1, _translate("standard", "scientific"))
        self.model.setText(_translate("standard", "Обычный"))
